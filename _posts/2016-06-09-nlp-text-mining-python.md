...
# Intro to Text Mining and Natural Language Processing in Python (Part 1)
...
*Note2*: n-grams are implemented in sklearns' [TF-IDF vectorizer](http://scikit-learn.org/stable/modules/generated/sklearn.feature_extraction.text.TfidfVectorizer.html)
